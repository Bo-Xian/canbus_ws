...
private:
    ...
    void dynamicReconfigureCallback(fork_controller::forkControllerParamConfig &config, uint32_t level);
    ...
    dynamic_reconfigure::Server<fork_controller::forkControllerParamConfig> cfg_server_;
    dynamic_reconfigure::Server<fork_controller::forkControllerParamConfig>::CallbackType cfg_Cb_;
